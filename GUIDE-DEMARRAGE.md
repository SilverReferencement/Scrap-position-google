...
✅ Si tout fonctionne, le workflow s'exécutera automatiquement **le 1er du mois à 6h00 (heure de Paris)** !
...
```yaml
schedule:
  - cron: '0 5 1 * *'  # Le 1er de chaque mois à 5h UTC (6h heure de Paris hiver / 7h été)
```
